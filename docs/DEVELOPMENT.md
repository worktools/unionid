...
- #25/#81/#83/#85/#87：已实现有限直接自递归 named ADT、穷尽 `match` update assignment、DML typed returning 和原子 sort/take mutation target；互递归、用户泛型和递归查询函数继续根据实际场景分别设计。
