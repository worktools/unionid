...
- #8/#10/#11/#34–#36：在已实现的默认值、版本化 value codec、完整嵌套 ADT 覆盖分析、typed arithmetic/value construction、多键 sort、范围 take、布尔组合、`contains/length/any/all`、Option helper、typed 参数和 schema-aware prepared query 上继续完善普通 derive 与 group/aggregate。#9/#12/#34–#36 已完成。
