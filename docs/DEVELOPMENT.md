...
- `unionid::scalars` 提供六种生产标量的 Rust 值域、规范 serde payload 与边界校验；开发分支已接入原生 ScalarType/Value、无损 serde、protocol v2 参数和独立 value codec 2；完整协议预检与持久格式升级仍由 #137 跟踪。已实现范围见 [SCALARS.md](SCALARS.md)。
