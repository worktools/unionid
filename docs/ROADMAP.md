...
4. [#15](https://github.com/worktools/unionid/issues/15)、[#17](https://github.com/worktools/unionid/issues/17) 已完成；[#18](https://github.com/worktools/unionid/issues/18) 已实现版本化 runner/ledger，下一项推进 [#19](https://github.com/worktools/unionid/issues/19) 的声明式 schema diff 与可检查草稿。[#16](https://github.com/worktools/unionid/issues/16) 的 Explain 与 M4 体验工作暂后置。
