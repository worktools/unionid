...
4. [#15](https://github.com/worktools/unionid/issues/15)、[#17](https://github.com/worktools/unionid/issues/17)–[#20](https://github.com/worktools/unionid/issues/20) 已完成，M2/M3 核心链路闭合。[#22](https://github.com/worktools/unionid/issues/22)、[#23](https://github.com/worktools/unionid/issues/23)、[#66](https://github.com/worktools/unionid/issues/66) 与 [#69](https://github.com/worktools/unionid/issues/69) 已完成。按核心优先先由 [#74](https://github.com/worktools/unionid/issues/74) 验证端到端数据正确性，再由 [#75](https://github.com/worktools/unionid/issues/75) 测量工作负载；之后完成 [#70](https://github.com/worktools/unionid/issues/70) 的交互体验与 [#76](https://github.com/worktools/unionid/issues/76) 的安装发布。
