...
4. [#15](https://github.com/worktools/unionid/issues/15)、[#17](https://github.com/worktools/unionid/issues/17)–[#20](https://github.com/worktools/unionid/issues/20) 已完成，M3 核心链路闭合。[#22](https://github.com/worktools/unionid/issues/22) 与 [#23](https://github.com/worktools/unionid/issues/23) 已实现 versioned typed 接口、有界服务和优雅关闭；[#66](https://github.com/worktools/unionid/issues/66) 补齐输入完整性和 REPL 续写，[#69](https://github.com/worktools/unionid/issues/69) 交付规范 formatter 后，由 [#70](https://github.com/worktools/unionid/issues/70) 继续历史、补全和远程 introspection，再进入 [#13](https://github.com/worktools/unionid/issues/13)/[#14](https://github.com/worktools/unionid/issues/14) 的故障证据与 [#24](https://github.com/worktools/unionid/issues/24) 的发布验收。
