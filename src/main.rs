...
struct VersionReport {
    ...
    readable_storage_formats: [u32; 9],
    readable_backup_formats: [u32; 5],
...
fn version_report() -> VersionReport {
    VersionReport {
        ...
        readable_storage_formats: [1, 2, 3, 4, 5, 6, 7, 8, 9],
        readable_backup_formats: [1, 2, 3, 4, 5],
